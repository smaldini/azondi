...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t38716 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t38716 = (function (val,box,meta38717){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t38716.cljs$lang$type = true;
cljs.core.async.impl.channels.t38716.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t38716";
cljs.core.async.impl.channels.t38716.cljs$lang$ctorPrWriter = (function (this__21616__auto__,writer__21617__auto__,opt__21618__auto__){return cljs.core._write(writer__21617__auto__,"cljs.core.async.impl.channels/t38716");
});
cljs.core.async.impl.channels.t38716.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t38716.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38718){var self__ = this;
var _38718__$1 = this;return self__.meta38717;
});
cljs.core.async.impl.channels.t38716.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38718,meta38717__$1){var self__ = this;
var _38718__$1 = this;return (new cljs.core.async.impl.channels.t38716(self__.val,self__.box,meta38717__$1));
});
cljs.core.async.impl.channels.__GT_t38716 = (function __GT_t38716(val__$1,box__$1,meta38717){return (new cljs.core.async.impl.channels.t38716(val__$1,box__$1,meta38717));
});
}
return (new cljs.core.async.impl.channels.t38716(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__21619__auto__,writer__21620__auto__,opts__21621__auto__){return cljs.core._write(writer__21620__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__21616__auto__,writer__21617__auto__,opt__21618__auto__){return cljs.core._write(writer__21617__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_38719 = self__.takes.pop();if((taker_38719 == null))
{} else
{if(taker_38719.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_38720 = taker_38719.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_38720,taker_38719){
return (function (){return (take_cb_38720.cljs$core$IFn$_invoke$arity$1 ? take_cb_38720.cljs$core$IFn$_invoke$arity$1(null) : take_cb_38720.call(null,null));
});})(take_cb_38720,taker_38719))
);
} else
{}
{
