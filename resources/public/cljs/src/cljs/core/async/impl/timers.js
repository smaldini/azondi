...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__21616__auto__,writer__21617__auto__,opt__21618__auto__){return cljs.core._write(writer__21617__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_38776 = 0;while(true){
if((i_38776 < arr.length))
{(arr[i_38776] = null);
{
var G__38777 = (i_38776 + 1);
i_38776 = G__38777;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__21616__auto__,writer__21617__auto__,opt__21618__auto__){return cljs.core._write(writer__21617__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_38783 = (self__.level + 1);while(true){
if((i_38783 <= (new_level + 1)))
{(update[i_38783] = self__.header);
{
var G__38784 = (i_38783 + 1);
i_38783 = G__38784;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_38785 = 0;while(true){
if((i_38785 <= self__.level))
{var links_38786 = (update[i_38785]).forward;if(((links_38786[i_38785]) === x__$1))
{(links_38786[i_38785] = (x__$1.forward[i_38785]));
{
var G__38787 = (i_38785 + 1);
i_38785 = G__38787;
continue;
}
} else
{{
var G__38788 = (i_38785 + 1);
i_38785 = G__38788;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__21049__auto__ = (cljs.core.truth_((function (){var and__21037__auto__ = me;if(cljs.core.truth_(and__21037__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__21037__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__21049__auto__))
